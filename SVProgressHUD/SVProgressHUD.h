...
@property (assign, nonatomic) BOOL tapToFinishAutoDismiss UI_APPEARANCE_SELECTOR;  // default is NO
...
+ (void)setTapToFinishFadeOutTimer:(BOOL)tapToFinishFadeOutTimer;   // default is NO
