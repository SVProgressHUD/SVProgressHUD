...
typedef NS_ENUM(NSUInteger, SVProgressHUDAnimationType) {
    SVProgressHUDAnimationTypeFlat,      // use custom flat animation (indefinite animated ring)
    SVProgressHUDAnimationTypeIOSNative  // use ios native UIActivityIndicatorView
};
