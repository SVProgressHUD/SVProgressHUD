...
typedef NS_ENUM(NSUInteger, SVProgressHUDAnimationType) {
    ...
    SVProgressHUDAnimationTypeCustom NS_SWIFT_NAME(custom)  // using custom image view
};
...
@property (strong, nonatomic, nullable) UIImageView *loadingImageView;                                  // would be used for SVProgressHUDAnimationTypeCustom
