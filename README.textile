...
*NB! If you're using SVProgressHUD in a non-ARC project, don't forget to add "-fobjc-arc" compiler flag to SVProgressHUD.m file in the target's settings.* Otherwise, the app may crash on the second HUD appearing.
