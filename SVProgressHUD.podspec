Pod::Spec.new do |s|
  ...
  s.description = 'SVProgressHUD is a clean and easy-to-use HUD meant to display the progress of an ongoing task on iOS and tvOS. It’s a simplified alternative to the popular MBProgressHUD. The success and error icons are from Freepik from Flaticon and are licensed under Creative Commons BY 3.0.'
